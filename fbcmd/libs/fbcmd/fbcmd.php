...
////////////////////////////////////////////////////////////////////////////////
  ...
  #AddCommand('MUTUAL',	  '[uid]~Show the mutual friends with user having uid provided'); 
...
//       var_dump( $date );
       ...
       file_put_contents($fileName, "//QUERY: ".$fbcmdParams[1]."\n\n".json_encode( $fbReturn)."\n" );
       //       print json_encode($fbReturn);
...
////////////////////////////////////////////////////////////////////////////////
  ...
  function MultiFQL($queryList) {
    ...
    try {
       ...
       //       var_dump($queryList[0]["Stream"]);
//       var_dump($fbMultiFqlReturn);
