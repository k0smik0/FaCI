...
public class GephiFriendnessGraphGenerator implements FriendnessGraphGenerator {
	...
	@Inject
	public GephiFriendnessGraphGenerator(UndirectedGraph undirectedGraph, GraphFactory graphFactory, World world) {
